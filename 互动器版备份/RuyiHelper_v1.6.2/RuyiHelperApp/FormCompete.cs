...
namespace RueHelper
{
    public partial class FormCompete : Form
    {
        ...
        public FormCompete(int num, string allScore,string Rank)
        {
            InitializeComponent();
            ///SetPanel(num);
        ...
        public void AddGroupBox(int num ,string str,string Rank)
        {
