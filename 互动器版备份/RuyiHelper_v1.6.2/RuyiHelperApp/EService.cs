...
namespace RueHelper
{
    ...
    public class EService : IEService
    {
        ...
        public string Exit(string accessValue,string chapter)
        {
            ...
            Global.g_teacherName = "";
            Global.g_teacherPinying = "";

            Form1.DeleteFile("*");
            FormDraw.ClearRecord();
            //System.Diagnostics.Process.Start("explorer.exe", "http://1.rueteacher.applinzi.com/index.php/Manage/Index/login.html");
            //int a = Global.getSchoolID();
            //string schoolid = a.ToString();
            //int b = Global.getTeacherID();
            //string teacherid = b.ToString();
            //string url = "http://1.rueteacher.applinzi.com/index.php/Manage/Index/indexinfo/schoolid/"+ schoolid + "/teacherid/" + teacherid;
