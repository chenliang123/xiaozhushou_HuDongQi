...
namespace RueHelper
{
    delegate void SetControls(int w, PictureBox pb, int i);
    public partial class Form8 : Form
    {
        ...
        string[] answerList = { "A", "B", "C", "D", "未答", "其它" };
        decimal[] countValues = { 0, 0, 0, 0, 1, 0 };
        int[] peopleValues = { 0, 0, 0, 0, 0, 0 };
        public Form8(string id, string type, string answer, string numberstr)
        {
            if (type == "1")
            {
                answerList = new string[] { "✔", "✘", "未答", "其它" };
            }
            _id = id;
            InitializeComponent();
            ...
            this.TopMost = true;
#if DEBUG
            this.TopMost = false;//Form8习题结果统计
#endif
