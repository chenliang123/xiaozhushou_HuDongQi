...
namespace RueHelper
{
    public partial class FormInter : Form
    {
        ...
        private void statisticABCD()
        {
            ...
            //try{
            //    DrawingArcs(label_A, "A", nA, si.Length);
            //    DrawingArcs(label_B, "B", nB, si.Length);
            //    DrawingArcs(label_C, "C", nC, si.Length);
            //    DrawingArcs(label_D, "D", nD, si.Length);
            //    DrawingArcs(label_R, "R", nR, si.Length);
            //    DrawingArcs(label_W, "W", nW, si.Length);
            //}catch(Exception e1){
